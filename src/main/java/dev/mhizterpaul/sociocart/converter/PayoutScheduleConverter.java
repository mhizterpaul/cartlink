package dev.mhizterpaul.sociocart.converter;

import dev.mhizterpaul.sociocart.model.Wallet.PayoutSchedule;
...
public class PayoutScheduleConverter implements AttributeConverter<PayoutSchedule, Integer> {
    ...
    public PayoutSchedule convertToEntityAttribute(Integer days) {
        ...
        throw new IllegalArgumentException("Invalid payout schedule: " + days);
    }
}
