...
import dev.paul.cartlink.analytics.dto.LinkAnalyticsResponse; // Placeholder
import dev.paul.cartlink.analytics.dto.LinkTrafficSourceResponse; // Placeholder
...
public class LinkAnalyticsControllerIT {
    ...
    @Autowired private ProductLinkRepository productLinkRepository; // Assuming this exists
    ...
    void setUpTestData() {
        ...
        product.setPrice(java.math.BigDecimal.valueOf(50.00));
        product.setStock(20);
    ...
    class GetLinkAnalytics {
        ...
        void whenLinkExists_thenReturnsAnalytics() throws Exception {
            // The actual analytics data would be generated by the service based on tracking.
            // For an IT, we're checking if the endpoint is reachable and returns the expected structure for an existing link.
            // The service might return empty/zeroed analytics for a new link.
            mockMvc.perform(get("/api/v1/merchants/{merchantId}/products/links/{linkId}/analytics", testMerchantId, testLinkId)
    ...
    class GetLinkTrafficSources {
        ...
        void whenLinkExists_thenReturnsTrafficSources() throws Exception {
            ...
            mockMvc.perform(get("/api/v1/merchants/{merchantId}/products/links/{linkId}/traffic", testMerchantId, testLinkId))
                    .andExpect(status().isOk())
    ...
    // - Assumes existence of ProductLink model/repository for setting up test data. This might need adjustment
    ...
    // - Actual analytics values depend on service logic and data tracking, which are not simulated in detail here.
}
